...
type ContentfulContactComponentContentFragment = { readonly __typename: 'ContentfulContactComponent', readonly name: string | null, readonly description: string | null, readonly formButtonText: string | null, readonly errorMessage: string | null, readonly heading: { readonly raw: string | null } | null, readonly formFields: ReadonlyArray<{ readonly key: string | null, readonly label: string | null } | null> | null, readonly notice: { readonly raw: string | null } | null, readonly siteLogo: { readonly url: string | null } | null };
